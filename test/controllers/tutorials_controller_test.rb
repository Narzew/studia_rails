...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { author_id: @tutorial.author_id, category_id: @tutorial.category_id, complete: @tutorial.complete, content: @tutorial.content, description: @tutorial.description, name: @tutorial.name, type_id: @tutorial.type_id } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { author_id: @tutorial.author_id, category_id: @tutorial.category_id, complete: @tutorial.complete, content: @tutorial.content, description: @tutorial.description, name: @tutorial.name, type_id: @tutorial.type_id } }
